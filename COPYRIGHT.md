...
# Character IP and Worldbuilding | 角色 IP 與世界觀
...
No commercial use, redistribution, republication,
adaptation, or derivative commercial works are permitted
without prior written permission from the author.  
未經作者事前書面授權，不得進行商業使用、轉載、出版、改作或製作衍生商業作品。  

---

# AI-Assisted Creation | AI 輔助創作說明

Some visual assets or drafts may be created with the assistance of AI tools.  
部分圖像素材或草稿可能透過 AI 工具輔助產生。  
...
若授權範圍產生疑義，以角色 IP 與世界觀相關限制為優先解釋。  
